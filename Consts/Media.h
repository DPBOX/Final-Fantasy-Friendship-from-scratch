...
extern const unsigned char binary_Image_hero_png_size[];

extern const unsigned char binary_Image_avatar_png_start[];
extern const unsigned char binary_Image_avatar_png_size[];

extern const unsigned char binary_Image_smolder_fly_right_png_start[];
extern const unsigned char binary_Image_smolder_fly_right_png_size[];

extern const unsigned char binary_Image_simple_panel_png_start[];
extern const unsigned char binary_Image_simple_panel_png_size[];

extern const unsigned char binary_Image_continue_arrow_png_start[];
extern const unsigned char binary_Image_continue_arrow_png_size[];

extern const unsigned char binary_Image_text_font_png_start[];
extern const unsigned char binary_Image_text_font_png_size[];

extern const unsigned char binary_Image_text_font_yellow_png_start[];
extern const unsigned char binary_Image_text_font_yellow_png_size[];

extern const unsigned char binary_Image_text_font_red_png_start[];
extern const unsigned char binary_Image_text_font_red_png_size[];

extern const unsigned char binary_Image_heading_font_png_start[];
extern const unsigned char binary_Image_heading_font_png_size[];
/*
extern const unsigned char binary_Image_hero_png_start[];
extern const unsigned char binary_Image_hero_png_size[];

extern const unsigned char binary_Image_guard_png_start[];
extern const unsigned char binary_Image_guard_png_size[];

extern const unsigned char binary_Image_rpg_indoor_png_start[];
extern const unsigned char binary_Image_rpg_indoor_png_size[];

extern const unsigned char binary_Image_tileset_sontos_house_png_start[];
extern const unsigned char binary_Image_tileset_sontos_house_png_size[];

extern const unsigned char binary_Image_tileset_jail_png_start[];
extern const unsigned char binary_Image_tileset_jail_png_size[];

extern const unsigned char binary_Image_sleeping_effect_png_start[];
extern const unsigned char binary_Image_sleeping_effect_png_size[];
*/
extern const unsigned char binary_Image_inventory_icons_png_start[];
extern const unsigned char binary_Image_inventory_icons_png_size[];
...
extern const unsigned char binary_Image_nightwish_small_portrait_png_size[];

extern const unsigned char binary_Image_gallus_portrait_png_start[];
extern const unsigned char binary_Image_gallus_portrait_png_size[];

extern const unsigned char binary_Image_gallus_small_portrait_png_start[];
extern const unsigned char binary_Image_gallus_small_portrait_png_size[];

extern const unsigned char binary_Image_progress_bar_background_png_start[];
extern const unsigned char binary_Image_progress_bar_background_png_size[];

extern const unsigned char binary_Image_progress_bar_blue_png_start[];
extern const unsigned char binary_Image_progress_bar_blue_png_size[];

extern const unsigned char binary_Image_progress_bar_green_png_start[];
extern const unsigned char binary_Image_progress_bar_green_png_size[];

extern const unsigned char binary_Image_progress_bar_orange_png_start[];
extern const unsigned char binary_Image_progress_bar_orange_png_size[];

extern const unsigned char binary_Image_progress_bar_pink_png_start[];
extern const unsigned char binary_Image_progress_bar_pink_png_size[];

extern const unsigned char binary_Image_progress_bar_red_png_start[];
extern const unsigned char binary_Image_progress_bar_red_png_size[];

extern const unsigned char binary_Image_entrance_png_start[];
extern const unsigned char binary_Image_entrance_png_size[];

extern const unsigned char binary_Image_battle_testing_png_start[];
extern const unsigned char binary_Image_battle_testing_png_size[];
/*
extern const unsigned char binary_Music_rain_mp3_start[];
extern const unsigned char binary_Music_rain_mp3_size[];

extern const unsigned char binary_Music_wagon_mp3_start[];
extern const unsigned char binary_Music_wagon_mp3_size[];
...
extern const unsigned char binary_Sound_bell_wav_size[];

extern const unsigned char binary_Image_gregor_png_start[];
extern const unsigned char binary_Image_gregor_png_size[];

extern const unsigned char binary_Sound_crumble_wav_start[];
extern const unsigned char binary_Sound_crumble_wav_size[];

extern const unsigned char binary_Sound_key_item_wav_start[];
extern const unsigned char binary_Sound_key_item_wav_size[];

extern const unsigned char binary_Sound_skeleton_wav_start[];
extern const unsigned char binary_Sound_skeleton_wav_size[];

extern const unsigned char binary_Sound_reveal_wav_start[];
extern const unsigned char binary_Sound_reveal_wav_size[];

extern const unsigned char binary_Sound_grate_wav_start[];
extern const unsigned char binary_Sound_grate_wav_size[];

extern const unsigned char binary_Sound_unlock_wav_start[];
extern const unsigned char binary_Sound_unlock_wav_size[];
*/
extern const unsigned char binary_Sound_cursor_wav_start[];
extern const unsigned char binary_Sound_cursor_wav_size[];

extern const unsigned char binary_Sound_confirm_wav_start[];
extern const unsigned char binary_Sound_confirm_wav_size[];

extern const unsigned char binary_Sound_back_wav_start[];
extern const unsigned char binary_Sound_back_wav_size[];

extern const unsigned char binary_Sound_buzzer_wav_start[];
extern const unsigned char binary_Sound_buzzer_wav_size[];
